...
@Tag(name = "Doctor Specialization Management", description = "APIs for managing doctor-specialization relationships (junction table)")
...
public class SpecializationController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "201", description = "Specialization created successfully", content = @Content(schema = @Schema(implementation = SpecializationResponseDto.class))),
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Specialization found", content = @Content(schema = @Schema(implementation = SpecializationResponseDto.class))),
        ...
        public ResponseEntity<ResponseModel<Page<SpecializationResponseDto>>> searchSpecializationsBySpeciality(
                        ...
                        @Parameter(description = "Pagination information") Pageable pageable) {
                Page<SpecializationResponseDto> specializations = specializationService.findBySpeciality(speciality,
                                pageable);
                return ResponseEntity.ok(ResponseModel.<Page<SpecializationResponseDto>>builder()
                                .status(HttpStatus.OK)
        ...
        public ResponseEntity<ResponseModel<Page<SpecializationResponseDto>>> searchSpecializationsBySubspecialization(
                        ...
                        @Parameter(description = "Pagination information") Pageable pageable) {
                Page<SpecializationResponseDto> specializations = specializationService
                                .findBySubspecialization(subspecialization, pageable);
                return ResponseEntity.ok(ResponseModel.<Page<SpecializationResponseDto>>builder()
                                .status(HttpStatus.OK)
                                .message("Specializations found")
                                .data(specializations)
        ...
        public ResponseEntity<ResponseModel<List<Object[]>>> getMostCommonSpecialities() {
                List<Object[]> commonSpecialities = specializationService.findDoctorsWithMultipleSpecializations()
                                .stream()
        ...
        public ResponseEntity<ResponseModel<List<SpecializationResponseDto>>> findSpecializationsWithSubspecialization() {
                List<SpecializationResponseDto> specializations = specializationService
                                .findByDoctorId(java.util.UUID.randomUUID());
                return ResponseEntity.ok(ResponseModel.<List<SpecializationResponseDto>>builder()
                                .status(HttpStatus.OK)
        ...
        public ResponseEntity<ResponseModel<List<SpecializationResponseDto>>> createSpecializationsBatch(
                ...
                List<SpecializationResponseDto> specializations = specializationService.createBatch(doctorId,
                                requestDtos);
                return ResponseEntity.status(HttpStatus.CREATED)

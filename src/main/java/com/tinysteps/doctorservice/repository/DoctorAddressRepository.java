...
public interface DoctorAddressRepository extends JpaRepository<DoctorAddress, DoctorAddressId> {
         ...
         */
        @Modifying
        @Query("DELETE FROM DoctorAddress da WHERE da.doctorId = :doctorId")
         ...
         */
        @Modifying
        @Query("DELETE FROM DoctorAddress da WHERE da.addressId = :addressId")
         ...
         */
        @Modifying
        @Query("DELETE FROM DoctorAddress da WHERE da.doctorId = :doctorId AND da.addressId = :addressId")
        void deleteByDoctorIdAndAddressId(@Param("doctorId") UUID doctorId, @Param("addressId") UUID addressId);
